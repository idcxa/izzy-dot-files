...
globalkeys = my_table.join(
    ...
    awful.key({ modkey, "Shift"  }, "s", function () awful.util.spawn( os.getenv("HOME").."/.config/scripts/scrshot.sh alt" ) end,
        {description = "screenshot region" , group = "dmenu scripts" }),
    awful.key({ modkey }, "s", function () awful.util.spawn( os.getenv("HOME").."/.config/scripts/scrshot.sh reg" ) end,
        {description = "screenshot region" , group = "dmenu scripts" }),
   ...
   -- awful.key({ modkey }, "Right", function () lain.util.tag_view_nonempty(1) end,
    ...
    awful.key({ modkey,           }, "Return", function () awful.spawn( terminal) end,
              {description = "alacritty", group = "super"}),
    awful.key({ modkey, "Shift" }, "r", awesome.restart,
              {description = "reload awesome", group = "awesome"}),
    awful.key({ modkey, "Shift"   }, "q",  function () awful.spawn.with_shell( '/home/izzy/.config/rofi/powermenu/powermenu.sh' ) end,
    ...
    -- Brightness
    awful.key({ }, "XF86MonBrightnessUp", function () os.execute("$HOME/.config/scripts/brightness.rb up") end,
              {description = "+10%", group = "hotkeys"}),
    awful.key({ }, "XF86MonBrightnessDown", function () os.execute("$HOME/.config/scripts/brightness.rb down") end,
              {description = "-10%", group = "hotkeys"}),
    ...
    awful.key({ }, "XF86AudioRaiseVolume",
        function ()
            os.execute(string.format("amixer -q set %s 5%%+ nocap", beautiful.volume.channel))

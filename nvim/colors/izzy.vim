...
call <SID>set_hi("MatchParen", s:pink, s:none, "italic")
...
let s:one = [231, "#444444"]
let s:two = [231, "#aaaaaa"]
"let s:red = [231, "#87875f"]

call <SID>set_hi("BufferCurrent", s:default_white, s:dark_gray, "NONE")
call <SID>set_hi("BufferCurrentIndex", s:pink, s:dark_gray, "NONE")
call <SID>set_hi("BufferCurrentMod", s:default_white, s:dark_gray, "NONE")
call <SID>set_hi("BufferCurrentSign", s:pink, s:dark_gray, "NONE")
call <SID>set_hi("BufferCurrentTarget", s:magenta, s:dark_gray, "bold")
call <SID>set_hi("BufferVisible", s:one, s:two, "NONE")
call <SID>set_hi("BufferVisibleIndex", s:one, s:two, "NONE")
call <SID>set_hi("BufferVisibleMod", s:pink, s:two, "NONE")
...
call <SID>set_hi("BufferTabpages", s:pink, s:one, "bold")

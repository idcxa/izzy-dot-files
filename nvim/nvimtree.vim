...
let g:nvim_tree_ignore = [ 'node_modules', '.cache' ] "empty by default
...
" selectable.
let g:nvim_tree_special_files = { 'README.md': 1, 'Makefile': 1, 'MAKEFILE': 1, 'shell.nix': 1 } " List of filenames that gets highlighted with NvimTreeSpecialFile
